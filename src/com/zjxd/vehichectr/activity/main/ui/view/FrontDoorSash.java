...
public class FrontDoorSash extends RelativeLayout implements OnTouchListener{
	...
	public FrontDoorSash(Context context) {
		super(context);
		onCreate(context);
	}

	public FrontDoorSash(Context context, AttributeSet attrs) {
		super(context, attrs);
		onCreate(context);
	}

	public FrontDoorSash(Context context, AttributeSet attrs, int defStyle) {
	...
	private void onCreate(Context context) {
		...
		inner.setImageResource(R.drawable.sub_car_window_iner);
		...
		mSash.setResourceId(R.drawable.sub_car_window_front_grass);
        ...
        outer.setImageResource(R.drawable.sub_car_window_front_outer);
